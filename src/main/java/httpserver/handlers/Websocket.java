...
public class Websocket implements HttpHandler {
    ...
    // FIXME this is a partial implementation of SSE that I copied from the other project
    //   The code doesn't event implement SSE correctly, it doesn't do websockets at all
    //   But maybe I can use this to get some ideas.
    ...
    public Websocket(final long keepAliveMillis) {
